    ...
    },
    {
        ...
        days: [
            ...
            },
            {
                ...
                exercises: [
                    { name: 'ESTIRAMIENTO PECTORAL', sets: 3, reps: '30-45s', descanso: '-', video: 'https://www.youtube.com/shorts/5IBR2KGEtyo', indicaciones: 'BLOQUE 1: Síndrome Cruzado Sup.\n- Marco de puerta.\n- Inhibe pectoral mayor/menor.\n- Retrae los hombros redondeados.' },
                    { name: 'ESTIRAMIENTO TRAPECIO SUP.', sets: 3, reps: '30s/lado', descanso: '-', video: 'https://www.youtube.com/watch?v=3LIhdRvaUSU', indicaciones: 'BLOQUE 1:\n- Trabaja la cabeza adelantada.\n- Mano detrás de la espalda.\n- Inclina la cabeza al lado contrario y ligeramente abajo.' },
                    { name: 'CHIN TUCKS (Retracciones Cervicales)', sets: 3, reps: '10', descanso: 'Completas', tempo: 'Hold 3-5s', video: 'https://www.youtube.com/shorts/SSHhkrY8xKo', indicaciones: 'BLOQUE 1:\n- Haz papada sin mirar arriba ni abajo.\n- Cabeza desliza horizontal en raíles.\n- Elonga y fortalece flexores profundos.' },
                    { name: 'WALL ANGELS', sets: 3, reps: '12', descanso: '60 seg', tempo: 'Lento', video: 'https://www.youtube.com/shorts/kqVFoVk6DEg', indicaciones: 'BLOQUE 1:\n- Lumbar, espalda alta y cabeza tocan pared.\n- No encojas hombros hacia orejas.\n- Foco en Trapecio Inferior y Medio.' },
                    { name: 'ESTIRAMIENTO FLEXORES CABALLERO', sets: 3, reps: '30-45s', descanso: '-', video: 'https://www.youtube.com/watch?v=-B18vcyiHck', indicaciones: 'BLOQUE 2: Síndrome Cruzado Inf. (Inhibición)\n- Posición half-kneeling.\n- Retroversión de cadera (no arquees lumbar).' },
                    { name: 'POSICIÓN DEL NIÑO (Childs Pose)', sets: 3, reps: '45s', descanso: '-', video: 'https://www.youtube.com/watch?v=cFcNQjKDI58', indicaciones: 'BLOQUE 2:\n- Descomprime carillas lumbares.\n- Respiración diafragmática profunda.' },
                    { name: 'INSECTO MUERTO (Dead Bugs)', sets: 3, reps: '10/lado', descanso: '60 seg', tempo: 'Muy lento', video: 'https://www.youtube.com/watch?v=o4GKiEoYClI', indicaciones: 'BLOQUE 2: Core Profundo (Activación)\n- Lumbar APLASTADA al suelo siempre.\n- Costillas no suben.\n- Si espalda arquea, no bajes tanto las piernas.' },
                    { name: 'PUENTE DE GLÚTEO (Glute Bridge)', sets: 3, reps: '15', descanso: '60 seg', tempo: 'Hold 2s', video: 'https://www.youtube.com/shorts/M-mnbbpJmXI', indicaciones: 'BLOQUE 2:\n- Haz retroversión pélvica primero (aplana espalda).\n- Sube estricamente de glúteo, no empujando de lumbar.' }
                ]
            },
            {
                name: 'Jueves',
